...
class DeformConvG(DeformConv2d):
    r"""Deformable 2D convolution.
    ...
    def __init__(self, *args, **kwargs):
        super(DeformConvG, self).__init__(*args, **kwargs)
    ...
    def forward(self, x):
        ...
        out = deform_conv2d(x, offset, self.weight, self.stride, self.padding, self.dilation, self.groups, self.deform_groups)
        return out, offset
